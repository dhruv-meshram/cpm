...
export default function SettingsPage() {
  ...
  return (
    <div className="select-none bg-white p-6 border rounded-xl shadow-xs space-y-12">
      {/* 1. Departments Section */}
      <div>
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-[18px] font-bold text-black tracking-tight font-sans">Project Departments</h2>
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-black hover:bg-black/80 text-white text-[13px] font-semibold px-4 py-2 rounded-lg shadow-sm transition-all cursor-pointer font-sans"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {departments.map((dep) => (
            <div
              key={dep.id}
              className={cn(
                "bg-white border border-[#e6e6e6] rounded-xl p-5 flex flex-col justify-between shadow-xs hover:shadow-sm transition-all relative overflow-hidden",
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mt-1 mb-2">
                  <h3 className="font-bold text-[15px] text-black flex items-center gap-2">
                    <span
      ...
      <div>
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-[18px] font-bold text-black tracking-tight font-sans">Project Tags Library</h2>
            <p className="text-[13px] text-[#a39e98] mt-1">
        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/40 backdrop-blur-xs">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md border border-[#e6e6e6] overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-[11px] font-bold text-black mb-1.5 uppercase tracking-wider">Department Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[11px] font-bold text-black mb-2 uppercase tracking-wider">Department Theme Color</label>
              ...
              {deletingDepartment.taskCount > 0 ? (
                <div className="space-y-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex gap-2">
                    ...
                    <div>
                      <h4 className="text-[11px] font-bold text-red-800 uppercase tracking-wider">Cannot Delete Department</h4>
        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/40 backdrop-blur-xs">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md border border-[#e6e6e6] overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-[11px] font-bold text-black mb-1.5 uppercase tracking-wider">Tag Name</label>
                <input
                  type="text"
      ...
      {deletingTag && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/40 backdrop-blur-xs">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md border border-[#e6e6e6] overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <p className="text-[13px] text-[#615d59]">
                Are you sure you want to delete tag <strong className="text-black">"{deletingTag.name}"</strong>? This will remove the tag association from all tasks. This action cannot be undone.
              </p>
            </div>
            <div className="px-6 py-4 bg-[#f6f5f4] border-t border-[#e6e6e6] flex justify-end gap-2">
              <button
