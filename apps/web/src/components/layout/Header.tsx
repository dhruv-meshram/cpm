...
export function Header() {
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-10 w-full">
      <div className="flex items-center bg-slate-100/70 hover:bg-slate-100 px-3 py-2 rounded-md w-72 focus-within:ring-2 focus-within:ring-black/10 focus-within:bg-white border border-transparent focus-within:border-black transition-all">
